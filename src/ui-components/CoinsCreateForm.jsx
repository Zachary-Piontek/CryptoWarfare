...
export default function CoinsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPercent_change_24h(initialValues.percent_change_24h);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Coins(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CoinsCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
